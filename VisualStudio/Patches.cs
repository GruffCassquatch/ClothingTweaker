namespace ClothingTweaker
{
    ...
    public class ChangeClothingParameters
    {
        public static void Postfix(GearItem __instance)
        {
            if (SettingsMain.mainSettings.modFunction && __instance.m_ClothingItem)
            {
                ...
                {
                    Patches.updateDecayRates(__instance);
                }
    ...
    internal static class Patches
    {
        public static void updateDecayRates(GearItem __instance)
        {
            ...
            ClothingItem ci = __instance.gameObject.GetComponent<ClothingItem>();

            __instance.m_GearItemData.m_DailyHPDecay *= SettingsMain.mainSettings.clothingDecayDaily;
            ci.m_DailyHPDecayWhenWornInside *= SettingsMain.mainSettings.clothingDecayIndoors;
            ci.m_DailyHPDecayWhenWornOutside *= SettingsMain.mainSettings.clothingDecayOutdoors;
        ...
        public static void changePostfabParameters(GearItem __instance, float warmth, float wetwarmth, float windproof, float waterproof, float protection, float mobility, float weight)
        {
            ...
            ci.m_Warmth = warmth;
            ci.m_WarmthWhenWet = wetwarmth;
            ci.m_Windproof = windproof;
            ci.m_Waterproofness = waterproof;
            ci.m_Toughness = protection;
            ci.m_SprintBarReductionPercent = mobility;
            __instance.WeightKG = weight;
        }
        ...
        public static void ChangePrefabParameters(string name, float warmth, float wetwarmth, float windproof, float waterproof, float protection, float mobility, float weight)
        {
            ...
            if (item == null) return;
            ClothingItem ci = item.gameObject.GetComponent<ClothingItem>();
            ci.m_Warmth = warmth;
            ci.m_WarmthWhenWet = wetwarmth;
            ci.m_Windproof = windproof;
            ci.m_Waterproofness = waterproof;
